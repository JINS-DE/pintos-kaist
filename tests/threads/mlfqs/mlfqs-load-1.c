...
void test_mlfqs_load_1( void ) {
    ...
    if ( elapsed < 38 ) fail( "load average took only %d seconds to rise above 0.5", elapsed );
    ...
    if ( load_avg > 50 ) fail( "load average stayed above 0.5 for more than 10 seconds" );
